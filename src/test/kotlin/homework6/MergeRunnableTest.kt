...
internal class MergeRunnableTest {
    companion object {
        ...
        fun mergeData() = listOf(
            ...
            Arguments.of(listOf(1, 1, 1, 1, 4), listOf(1, 4), listOf(1, 1, 1)),
            Arguments.of(listOf(2, 3, 4), listOf(2, 3, 4), listOf<Int>()),
            Arguments.of(listOf<Int>(), listOf<Int>(), listOf<Int>()),
        )
    }

    @MethodSource("mergeData")
    @ParameterizedTest(name = "runSync - {0}")
    ...
    @MethodSource("mergeData")
    @ParameterizedTest(name = "runParallel - {0}")
